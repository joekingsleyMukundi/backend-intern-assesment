...
func (x *CreateUserRequest) GetFullNamr() string {
	if x != nil {
		return x.FullNamr
	}
	return ""
...
const file_rpc_create_user_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04userB@Z>github.com/joekingsleyMukundi/backend-intern-assesment/auth/pbb\x06proto3"
