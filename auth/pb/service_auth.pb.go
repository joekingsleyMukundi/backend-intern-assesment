...
const file_service_auth_proto_rawDesc = "" +
	"\n" +
	"\x12service_auth.proto\x12\x02pb\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto2\x81\x01\n" +
	"\x04Auth\x12=\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"\x00\x12:\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"\x00B@Z>github.com/joekingsleyMukundi/backend-intern-assesment/auth/pbb\x06proto3"
...
var file_service_auth_proto_depIdxs = []int32{
	0, // 0: pb.Auth.CreateUser:input_type -> pb.CreateUserRequest
	1, // 1: pb.Auth.LoginUser:input_type -> pb.LoginUserRequest
	2, // 2: pb.Auth.CreateUser:output_type -> pb.CreateUserResponse
	3, // 3: pb.Auth.LoginUser:output_type -> pb.LoginUserResponse
